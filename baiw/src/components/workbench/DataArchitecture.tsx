...
import type { StarSchema, LineageItem, GapExtension, FactTable, DimensionTable, AggregateTable } from './types'
...
type SchemaTableItem =
  | ({ type: 'Fact' } & FactTable)
  | ({ type: 'Dimension' } & DimensionTable)
  | ({ type: 'Aggregate' } & AggregateTable)

function isDimension(t: SchemaTableItem): t is { type: 'Dimension' } & DimensionTable {
  return t.type === 'Dimension'
}

function isFactOrAggregate(t: SchemaTableItem): t is ({ type: 'Fact' } & FactTable) | ({ type: 'Aggregate' } & AggregateTable) {
          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-xs uppercase text-slate-500">
              <tr>
                ...
                <th className="px-3 py-2 font-medium">Source Entities</th>
              </tr>
            </thead>
