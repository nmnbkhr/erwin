import { Users, ArrowRight, MapPin, Landmark, Briefcase, Scale, PieChart, Building2, TrendingUp, Shield, type LucideIcon } from 'lucide-react'
import type { Stakeholder, ValueChainStep, BusinessCapability, ContextArea } from './types'
...
const STAKEHOLDER_ICONS: Record<string, LucideIcon> = {
  ...
  'Digital / Channels': Building2,
  'Customer': Users,
}

const PAKISTAN_ICONS: Record<string, LucideIcon> = {
  Regulatory: Landmark,
  Tax: Scale,
  Islamic: MapPin,
  FTP: TrendingUp,
...
export default function BusinessArchitecture({ data }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <h2 className="text-lg font-semibold text-slate-800 mb-4">Value Chain</h2>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <h2 className="text-lg font-semibold text-slate-800 mb-4">Module-Specific Context</h2>
