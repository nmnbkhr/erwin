...
export default function ProfitabilityRoadmap({ data }: Props) {
    ...
    <div className="space-y-4">
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <p className="text-sm text-slate-600 mb-4">
          Phased rollout from star-schema foundation to enterprise-scale customer profitability.
        </p>
